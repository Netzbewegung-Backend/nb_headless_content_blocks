...
+-------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| `Normalization/Normalizer/*`                    | One class per value type — see `Normalizers and transformers <../Reference/Normalizers.rst>`__                                                                                                            |
+-------------------------------------------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
Before the 2026-08 rewrite, one class held a giant `switch (true)` with instanceof chains over ContentBlocks internals, `makeInstance()` everywhere, and version hacks (`property_exists(...)`) to construct those internals in tests. The rewrite (see the `design record <../Design/ImproveToArray.rst>`__) replaced it with a **normalizer registry** — the Symfony Serializer pattern, hand-rolled without the dependency:
...
+====================================+====================================================+=====================================================+==============================================================+
| Normalizer                         | DI tag `nb_headless.normalizer`                    | own value types in the JSON output                  | `How-to <../Howto/RegisterCustomNormalizer.rst>`__           |
+------------------------------------+----------------------------------------------------+-----------------------------------------------------+--------------------------------------------------------------+
| Field value transformer            | DI tag `nb_headless.field_value_transformer`       | own string field shaping                            | `How-to <../Howto/RegisterFieldValueTransformer.rst>`__      |
+------------------------------------+----------------------------------------------------+-----------------------------------------------------+--------------------------------------------------------------+
| `headless.php`                     | per-Content Block PHP file                         | per-block post-processing of the whole `data` array | `How-to <../Howto/PostProcessWithHeadlessPhp.rst>`__         |
+------------------------------------+----------------------------------------------------+-----------------------------------------------------+--------------------------------------------------------------+
| `ModifyArrayRecursiveToArrayEvent` | PSR-14 event per field                             | legacy field overrides                              | `How-to <../Howto/ModifyFieldsWithEvent.rst>`__ (deprecated) |
+------------------------------------+----------------------------------------------------+-----------------------------------------------------+--------------------------------------------------------------+
| Sub data processors                | TypoScript `dataProcessing.`                       | TypoScript-computed data (menus, record lists)      | `How-to <../Howto/AddSubDataprocessors.rst>`__               |
+------------------------------------+----------------------------------------------------+-----------------------------------------------------+--------------------------------------------------------------+
| Image variants                     | `headless.yaml` + TypoScript `options.processing.` | responsive thumbnails                               | `How-to <../Howto/DefineImageVariants.rst>`__                |
+------------------------------------+----------------------------------------------------+-----------------------------------------------------+--------------------------------------------------------------+
