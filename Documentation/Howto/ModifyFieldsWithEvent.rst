...
| Legacy (event)              | Modern                                                                    |
+=============================+===========================================================================+
| Override by field name      | `Field value transformer <RegisterFieldValueTransformer.rst>`__ (strings) |
+-----------------------------+---------------------------------------------------------------------------+
| Override by value type      | `Custom normalizer <RegisterCustomNormalizer.rst>`__                      |
+-----------------------------+---------------------------------------------------------------------------+
| Whole-block post-processing | `headless.php <PostProcessWithHeadlessPhp.rst>`__                         |
+-----------------------------+---------------------------------------------------------------------------+
