...
All other `processor options <../Reference/ProcessorOptions.rst>`__ work as usual.

Troubleshooting
===============

If `thumbnails` do not show up, see :ref:`Troubleshooting → thumbnails are missing <troubleshooting-thumbnails-missing>`.
