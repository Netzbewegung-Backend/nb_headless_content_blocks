...
This guide shows how to replace a legacy `headless.php` thumbnail generator (the archived `ImageViewHelper pattern <../_archive/LegacyHeadlessPhpThumbnails.rst>`__) with declarative image variants.
